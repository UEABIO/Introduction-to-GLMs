...
- Data available [here](https://github.com/UEABIO/Introduction-to-GLMs/tree/slides/data)

- Scripts available [here](https://github.com/UEABIO/Introduction-to-GLMs/tree/slides/scripts)
...
1) You will get better insights into your models and various error distributions

2) You can check the stability of your models

3) You can run proper power analyses before you start your data collection

This is [Part One](https://aosmith.rbind.io/2018/08/29/getting-started-simulating-data/) of an excellent series of blog posts on simulating data
